...
# 2.8. Habilitar session.cookie_httponly e configurar timezone do PHP
...
# 2.12. Reiniciar o Apache para aplicar as alterações
...
echo "Acesse o GLPI via navegador em: http://glpi.ninjapfsense.com.br"

# 4.2. Criar um novo usuário com perfil super-admin
echo "Crie um novo usuário com perfil super-admin no GLPI."

# 4.3. Remover os usuários glpi, normal, post-only, tech.
echo "Remova os usuários glpi, normal, post-only, tech no GLPI."
